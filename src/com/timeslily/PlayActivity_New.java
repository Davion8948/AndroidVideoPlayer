...
import com.timeslily.videoplayer.PlaySurfaceView;

public class PlayActivity_New extends Activity implements OnClickListener {
    /** 时间线程中的循环标识 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.play_surfaceview);
        initUI();
        ...
        if (videos != null && (videoCount = videos.size()) > 0) {//初始化videoCount
            playVideo();
        }
    }
     ...
     */
    private void initUI() {
        playView = (PlaySurfaceView) findViewById(R.id.pv_play_view);
    ...
    private void playVideo() {
        ...
        if (video != null) {
            ...
            if (new File(videoPath).exists()) {
                ...
                FFmpeg.getInstance().prepareVideo(videoPath, dm);
                playView.playVideo();
                togglePlayButton(false);
            } else {//视频文件不存在 TODO
